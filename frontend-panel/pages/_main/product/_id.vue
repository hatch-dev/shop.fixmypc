        ...
        <div>
          ...
          <div class="product-detail">
            <div class="detail-left pr-30 pr-sm-0">
              ...
              <!-- Template Customizations Section -->
              <div v-if="product.customizations && product.customizations.length" class="template-accordion mt-30">
                <div 
                ...
                >
					  ...
					  >
						<h3 class="template-name">
						  {{ customization.template ? customization.template.title : `Template #${customization.template_id}` }}
						</h3>
						<i 
						  class="icon arrow-icon" 
						  :class="{
							'arrow-down': activeTemplate !== index,
							'arrow-up': activeTemplate === index
						  }"
						></i>
					  </div>
					  
					  <div 
						v-if="activeTemplate === index" 
