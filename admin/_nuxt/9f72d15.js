        ...
        885: function (t, e, c) {
            ...
            var l = c(476),
                ...
                o = {
                    ...
                    data: function () {
                        return { orderOptions: { created_at: { title: this.$t("category.date") }, title: { title: this.$t("index.title") }, status: { title: this.$t("category.status") } } };
                    },
                    mixins: [n.a, r.a],
                ...
                component = Object(d.a)(
                    ...
                    function () {
                        ...
                        return e("list-page", {
                            ref: "listPage",
                            attrs: { "list-api": "getFlashSales", "delete-api": "deleteFlashSale", "route-name": "flash-sales", name: t.$t("fSale.fSale"), "order-options": t.orderOptions, gate: "flash_sale" },
                            on: {
                                    ...
                                    fn: function (c) {
                                        ...
                                        return [
                                            e("tr", { staticClass: "lite-bold" }, [
                                                ...
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.sTime")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.eTime")))]),
                                                t._v(" "),
                                            ...
                                            t._l(l, function (c, l) {
                                                return e("tr", { key: l }, [
                                                    ...
                                                    t._v(" "),
                                                    e("td", [e("nuxt-link", { staticClass: "link", attrs: { to: "/flash-sales/".concat(c.id) } }, [e("h5", { staticClass: "mx-w-300x" }, [t._v(t._s(c.title))])])], 1),
                                                    t._v(" "),
                                                    e("td", { staticClass: "status", class: { active: 1 == c.status } }, [e("span", [t._v(t._s(t.getStatus(c.status)))])]),
                                                    t._v(" "),
                                                    e("td", [t._v(t._s(c.start_time))]),
                                                    t._v(" "),
                                                    e("td", [t._v(t._s(c.end_time))]),
                                                    t._v(" "),
