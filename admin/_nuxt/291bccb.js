    ...
    [121, 24, 31, 67],
    {
        ...
        470: function (t, e, r) {
            t.exports = (function () {
                            ...
                            if ((t.getAttribute("data-background-delimiter") && (o = t.getAttribute("data-background-delimiter")), t.getAttribute("data-background-image")))
                                ...
                                (u = -1 === u.indexOf("url(") ? "url(" + u + ")" : u),
                                    1 === c.length
                                        ...
                                        : t.setAttribute("style", (t.getAttribute("style") || "") + "background-image: " + u + "; background-image: -webkit-image-set(" + c + "); background-image: image-set(" + c + ")");
                            }
                ...
                return function () {
                    ...
                    for (var v, _ = n(c, i), b = 0; b < _.length; b++) (v = _[b]).getAttribute("data-placeholder-background") && (v.style.background = v.getAttribute("data-placeholder-background"));
                    return {
                        observe: function () {
                            for (var t = n(c, i), o = 0; o < t.length; o++) r(t[o]) || (s ? s.observe(t[o]) : (u(t[o]), e(t[o]), g(t[o])));
                        },
        ...
        896: function (t, e, r) {
            ...
            var v = {
                    ...
                    mixins: [l.a, h.a],
                    components: { LazyImage: d.default, ListPage: o.default },
                    computed: (function (t) {
                    ...
                    async duplicateProduct(productId) {
                        ...
                        try {
                        this.loading = true;
                        const response = await this.$axios.post(`https://shop.fixmypc.ie/api/admin/products/${productId}/duplicate`);
                        ...
                        if (response.data) {
                           ...
                           // Show success alert
                                ...
                                setTimeout(function(){
                                    //location.reload();
                                     window.location.href=`https://shop.fixmypc.ie/admin/products/${duplicateProductId}`;
                                },1000);
                                
                            }
                        } catch (error) {
                            showAlert('Error duplicating product');
                            console.error(error);
                        } finally {
                        this.loading = false;
                        }
                ...
                component = Object(m.a)(
                    ...
                    function () {
                        ...
                        return e("list-page", {
                            ref: "listPage",
                            attrs: { "list-api": "getProducts", "delete-api": "deleteProduct", "route-name": "products", name: t.$t("title.prod"), "order-options": t.orderByProduct, gate: "product" },
                            on: {
                                    ...
                                    fn: function (r) {
                                        ...
                                        return [
                                            e("tr", { staticClass: "lite-bold" }, [
                                                e("th", { staticClass: "w-50x mx-w-50x" }, [e("input", { attrs: { type: "checkbox" }, on: { change: t.checkAll } })]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("index.title")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("category.status")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.brand")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("error.cat")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.tRule")))]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.purchased")) + "(" + t._s(t.currencyIcon) + ")")]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.selling")) + "(" + t._s(t.currencyIcon) + ")")]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("prod.offered")) + "(" + t._s(t.currencyIcon) + ")")]),
                                                t._v(" "),
                                                e("th", [t._v(t._s(t.$t("category.created")))]),
                                                t._v(" "),
                                                e("th"), // Add header for duplicate button
                                                t._v(" "),
                                                e("th"),
                                                t._v(" "),
                                                e("th"),
                                            ...
                                            t._l(n, function (r, n) {
                                                return e("tr", { key: n }, [
                                                    e("td", { staticClass: "w-50x mx-w-50x" }, [
                                                        e("input", {
                                                            ...
                                                            on: {
                                                                change: function (e) {
                                                                    ...
                                                                    if (Array.isArray(n)) {
                                                                        var l = r.id,
                                                                            d = t._i(n, l);
                                                                        o.checked ? d < 0 && (t.cbList = n.concat([l])) : d > -1 && (t.cbList = n.slice(0, d).concat(n.slice(d + 1)));
                                                                    } else t.cbList = c;
                                                                },
                                                            },
                                                        }),
                                                    ...
                                                    e(
                                                        ...
                                                        [
                                                            e(
                                                                "nuxt-link",
                                                                { staticClass: "dply-felx j-left link", attrs: { to: "/products/".concat(r.id) } },
                                                                [
                                                                    e("lazy-image", { staticClass: "mr-20", attrs: { "data-src": t.getThumbImageURL(r.image), alt: r.title } }),
                                                                    t._v(" "),
                                                                    e("h5", { staticClass: "mx-w-400x" }, [t._v(t._s(r.title))]),
                                                                ],
                                                                1
                                                            ),
                                                        ],
                                                    ...
                                                    t._v(" "),
                                                    e("td", { staticClass: "status", class: { active: 1 == r.status } }, [e("span", [t._v(t._s(t.getStatus(r.status)))])]),
                                                    t._v(" "),
                                                    e(
                                                        "td",
                                                        [
                                                            r.brand
                                                                ? e("nuxt-link", { staticClass: "link", attrs: { to: "brands/".concat(r.brand.id) } }, [t._v("\n            " + t._s(r.brand.title) + "\n          ")])
                                                                : e("span", [t._v(t._s(t.$t("prod.na")))]),
                                                        ],
                                                        1
                                                    ),
                                                    t._v(" "),
                                                    e("td", [
                                                        e(
                                                            "span",
                                                            { staticClass: "dply-felx f-wrap gap-10 mx-w-300x j-left" },
                                                            t._l(r.product_categories, function (data, r) {
                                                                return e("nuxt-link", { key: r, staticClass: "link", attrs: { to: "/categories/".concat(data.category.id) } }, [
                                                    ...
                                                    e(
                                                        ...
                                                        [
                                                            r.tax_rules
                                                                ? e("nuxt-link", { staticClass: "link", attrs: { to: "tax-rules/".concat(r.tax_rules.id) } }, [t._v("\n            " + t._s(r.tax_rules.title) + "\n          ")])
                                                                : e("span", [t._v(t._s(t.$t("prod.na")))]),
                                                        ],
                                                        1
                                                    ),
                                                    t._v(" "),
                                                    e("td", [t._v(t._s(r.purchased))]),
                                                    t._v(" "),
                                                    e("td", [t._v(t._s(r.selling))]),
                                                    t._v(" "),
                                                    e("td", [r.offered ? e("span", [t._v("\n             " + t._s(r.offered) + "\n          ")]) : t._e()]),
                                                    t._v(" "),
                                                    e("td", [t._v(t._s(r.created))]),
                                                    t._v(" "),
                                                    e(
                                                        "td",
                                                        [e("nuxt-link", { staticClass: "lite-btn button", attrs: { to: "/rating-reviews?product=".concat(r.id) } }, [t._v("\n            " + t._s(t.$t("prod.reviews")) + "\n          ")])],
                                                        1
                                                    ),
                                                    t._v(" "),
                                                    e("td", [
                                                    t.$can("product", "create") 
                                                        ? e(
                                                            "button",
                                                            {
                                                            staticClass: "lite-btn duplicate-btn",
                                                            on: {
                                                                click: function(e) {
                                                                e.preventDefault();
                                                                t.duplicateProduct(r.id);
                                                                }
                                                            }
                                                            },
                                                            [t._v("\n            " + t._s(t.$t("prod.duplicate")) + "\n          ")]
                                                        )
                                                        : t._e()
                                                    ]),
                                                    e("td", [
                                                        t.$can("product", "edit")
                                                            ? e(
                                                                  "button",
                                                                  {
                                                                      ...
                                                                      on: {
                                                                          click: function (e) {
                                                                              return e.preventDefault(), t.$refs.listPage.editItem(r.id);
                                                                          },
                                                                      },
                                                                  },
            ...
            e.default = component.exports;
            installComponents(component, { LazyImage: r(469).default });
        },
    },
]);
